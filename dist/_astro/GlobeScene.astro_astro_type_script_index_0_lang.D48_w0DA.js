...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wm(i,e,t){const n=new Float32Array(Di),r=new G(0,1,0);return new In({name:"SphericalGaussianBlur",defines:{n:Di,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ql(){return new In({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ec(){return new In({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ss(),fragmentShader:`
	...
	`}class Eu extends Un{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new cu(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}function VA(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ur).join(`
`)}function HA(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function zA(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const a=i.getActiveAttrib(e,r),s=a.name;let o=1;a.type===i.FLOAT_MAT2&&(o=2),a.type===i.FLOAT_MAT3&&(o=3),a.type===i.FLOAT_MAT4&&(o=4),t[s]={type:a.type,location:i.getAttribLocation(e,s),locationSize:o}}return t}function Ur(i){return i!==""}function uc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function dc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const kA=/^[ \t]*#include +<([\w\d./]+)>/gm;function uo(i){return i.replace(kA,YA)}const WA=new Map;function YA(i,e){let t=Oe[e];if(t===void 0){const n=WA.get(e);if(n!==void 0)t=Oe[n],Me('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return uo(t)}const XA=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fc(i){return i.replace(XA,qA)}function qA(i,e,t,n){let r="";for(let a=parseInt(e);a<parseInt(t);a++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return r}function hc(i){let e=`precision ${i.precision} float;
...
*/var sn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},kr={duration:.5,overwrite:!1,delay:0},Ho,Dt,st,mn=1e8,nt=1/mn,fo=Math.PI*2,UE=fo/4,FE=0,Mu=Math.sqrt,GE=Math.cos,BE=Math.sin,yt=function(e){return typeof e=="string"},mt=function(e){return typeof e=="function"},$n=function(e){return typeof e=="number"},zo=function(e){return typeof e>"u"},Fn=function(e){return typeof e=="object"},Wt=function(e){return e!==!1},ko=function(){return typeof window<"u"},wa=function(e){return mt(e)||yt(e)},Cu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Ft=Array.isArray,VE=/random\([^)]+\)/g,HE=/,\s*/g,_c=/(?:-?\.?\d|\.)+/gi,Ru=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,rr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,qs=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,vu=/[+-]=-?[.\d]+/,zE=/[^,'"\[\]\s]+/gi,kE=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ut,Dn,ho,Wo,on={},Xa={},xu,yu=function(e){return(Xa=fr(e,on))&&Zt},Yo=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},Wr=function(e,t){return!t&&console.warn(e)},Du=function(e,t){return e&&(on[e]=t)&&Xa&&(Xa[e]=t)||on},Yr=function(){return 0},WE={suppressEvents:!0,isStart:!0,kill:!1},Pa={suppressEvents:!0,kill:!1},YE={suppressEvents:!0},Xo={},fi=[],po={},bu,en={},Zs={},Ic=30,Ua=[],qo="",Zo=function(e){var t=e[0],n,r;if(Fn(t)||mt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(r=Ua.length;r--&&!Ua[r].targetTest(t););n=Ua[r]}for(r=e.length;r--;)e[r]&&(e[r]._gsap||(e[r]._gsap=new Qu(e[r],n)))||e.splice(r,1);return e},wi=function(e){return e._gsap||Zo(An(e))[0]._gsap},wu=function(e,t,n){return(n=e[t])&&mt(n)?e[t]():zo(n)&&e.getAttribute&&e.getAttribute(t)||n},Yt=function(e,t){return(e=e.split(",")).forEach(t)||e},It=function(e){return Math.round(e*1e5)/1e5||0},ct=function(e){return Math.round(e*1e7)/1e7||0},or=function(e,t){var n=t.charAt(0),r=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+r:n==="-"?e-r:n==="*"?e*r:e/r},XE=function(e,t){for(var n=t.length,r=0;e.indexOf(t[r])<0&&++r<n;);return r<n},qa=function(){var e=fi.length,t=fi.slice(0),n,r;for(po={},fi.length=0,n=0;n<e;n++)r=t[n],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},Ko=function(e){return!!(e._initted||e._startAt||e.add)},Lu=function(e,t,n,r){fi.length&&!Dt&&qa(),e.render(t,n,!!(Dt&&t<0&&Ko(e))),fi.length&&!Dt&&qa()},Ou=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(zE).length<2?t:yt(e)?e.trim():e},Pu=function(e){return e},ln=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},qE=function(e){return function(t,n){for(var r in n)r in t||r==="duration"&&e||r==="ease"||(t[r]=n[r])}},fr=function(e,t){for(var n in t)e[n]=t[n];return e},gc=function i(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=Fn(t[n])?i(e[n]||(e[n]={}),t[n]):t[n]);return e},Za=function(e,t){var n={},r;for(r in e)r in t||(n[r]=e[r]);return n},Vr=function(e){var t=e.parent||ut,n=e.keyframes?qE(Ft(e.keyframes)):ln;if(Wt(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},ZE=function(e,t){for(var n=e.length,r=n===t.length;r&&n--&&e[n]===t[n];);return n<0},Uu=function(e,t,n,r,a){var s=e[r],o;if(a)for(o=t[a];s&&s[a]>o;)s=s._prev;return s?(t._next=s._next,s._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[r]=t,t._prev=s,t.parent=t._dp=e,t},ls=function(e,t,n,r){n===void 0&&(n="_first"),r===void 0&&(r="_last");var a=t._prev,s=t._next;a?a._next=s:e[n]===t&&(e[n]=s),s?s._prev=a:e[r]===t&&(e[r]=a),t._next=t._prev=t.parent=null},mi=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Li=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},KE=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},mo=function(e,t,n,r){return e._startAt&&(Dt?e._startAt.revert(Pa):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,r))},$E=function i(e){return!e||e._ts&&i(e.parent)},Sc=function(e){return e._repeat?hr(e._tTime,e=e.duration()+e._rDelay)*e:0},hr=function(e,t){var n=Math.floor(e=ct(e/t));return e&&n===e?n-1:n},Ka=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},cs=function(e){return e._end=ct(e._start+(e._tDur/Math.abs(e._ts||e._rts||nt)||0))},us=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=ct(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),cs(e),n._dirty||Li(n,e)),e},Fu=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Ka(e.rawTime(),t),(!t._dur||ia(0,t.totalDuration(),n)-t._tTime>nt)&&t.render(n,!0)),Li(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-nt}},wn=function(e,t,n,r){return t.parent&&mi(t),t._start=ct(($n(n)?n:n||e!==ut?dn(e,n,t):e._time)+t._delay),t._end=ct(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),Uu(e,t,"_first","_last",e._sort?"_start":0),Ao(t)||(e._recent=t),r||Fu(e,t),e._ts<0&&us(e,e._tTime),e},Gu=function(e,t){return(on.ScrollTrigger||Yo("scrollTrigger",t))&&on.ScrollTrigger.create(t,e)},Bu=function(e,t,n,r,a){if(jo(e,t,a),!e._initted)return 1;if(!n&&e._pt&&!Dt&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&bu!==tn.frame)return fi.push(e),e._lazy=[a,r],1},jE=function i(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||i(t))},Ao=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},JE=function(e,t,n,r){var a=e.ratio,s=t<0||!t&&(!e._start&&jE(e)&&!(!e._initted&&Ao(e))||(e._ts<0||e._dp._ts<0)&&!Ao(e))?0:1,o=e._rDelay,l=0,c,u,f;if(o&&e._repeat&&(l=ia(0,e._tDur,t),u=hr(l,o),e._yoyo&&u&1&&(s=1-s),u!==hr(e._tTime,o)&&(a=1-s,e.vars.repeatRefresh&&e._initted&&e.invalidate())),s!==a||Dt||r||e._zTime===nt||!t&&e._zTime){if(!e._initted&&Bu(e,t,r,n,l))return;for(f=e._zTime,e._zTime=t||(n?nt:0),n||(n=t&&!f),e.ratio=s,e._from&&(s=1-s),e._time=0,e._tTime=l,c=e._pt;c;)c.r(s,c.d),c=c._next;t<0&&mo(e,t,n,!0),e._onUpdate&&!n&&nn(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&nn(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===s&&(s&&mi(e,1),!n&&!Dt&&(nn(e,s?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},QE=function(e,t,n){var r;if(n>t)for(r=e._first;r&&r._start<=n;){if(r.data==="isPause"&&r._start>t)return r;r=r._next}else for(r=e._last;r&&r._start>=n;){if(r.data==="isPause"&&r._start<t)return r;r=r._prev}},pr=function(e,t,n,r){var a=e._repeat,s=ct(t)||0,o=e._tTime/e._tDur;return o&&!r&&(e._time*=s/e._dur),e._dur=s,e._tDur=a?a<0?1e10:ct(s*(a+1)+e._rDelay*a):s,o>0&&!r&&us(e,e._tTime=e._tDur*o),e.parent&&cs(e),n||Li(e.parent,e),e},Tc=function(e){return e instanceof kt?Li(e):pr(e,e._dur)},e_={_start:0,endTime:Yr,totalDuration:Yr},dn=function i(e,t,n){var r=e.labels,a=e._recent||e_,s=e.duration()>=mn?a.endTime(!1):e._dur,o,l,c;return yt(t)&&(isNaN(t)||t in r)?(l=t.charAt(0),c=t.substr(-1)==="%",o=t.indexOf("="),l==="<"||l===">"?(o>=0&&(t=t.replace(/=/,"")),(l==="<"?a._start:a.endTime(a._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(o<0?a:n).totalDuration()/100:1)):o<0?(t in r||(r[t]=s),r[t]):(l=parseFloat(t.charAt(o-1)+t.substr(o+1)),c&&n&&(l=l/100*(Ft(n)?n[0]:n).totalDuration()),o>1?i(e,t.substr(0,o-1),n)+l:s+l)):t==null?s:+t},Hr=function(e,t,n){var r=$n(t[1]),a=(r?2:1)+(e<2?0:1),s=t[a],o,l;if(r&&(s.duration=t[1]),s.parent=n,e){for(o=s,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Wt(l.vars.inherit)&&l.parent;s.immediateRender=Wt(o.immediateRender),e<2?s.runBackwards=1:s.startAt=t[a-1]}return new Tt(t[0],s,t[a+1])},_i=function(e,t){return e||e===0?t(e):t},ia=function(e,t,n){return n<e?e:n>t?t:n},Pt=function(e,t){return!yt(e)||!(t=kE.exec(e))?"":t[1]},t_=function(e,t,n){return _i(n,function(r){return ia(e,t,r)})},Eo=[].slice,Vu=function(e,t){return e&&Fn(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&Fn(e[0]))&&!e.nodeType&&e!==Dn},n_=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(r){var a;return yt(r)&&!t||Vu(r,1)?(a=n).push.apply(a,An(r)):n.push(r)})||n},An=function(e,t,n){return st&&!t&&st.selector?st.selector(e):yt(e)&&!n&&(ho||!mr())?Eo.call((t||Wo).querySelectorAll(e),0):Ft(e)?n_(e,n):Vu(e)?Eo.call(e,0):e?[e]:[]},_o=function(e){return e=An(e)[0]||Wr("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return An(t,n.querySelectorAll?n:n===e?Wr("Invalid scope")||Wo.createElement("div"):e)}},Hu=function(e){return e.sort(function(){return .5-Math.random()})},zu=function(e){if(mt(e))return e;var t=Fn(e)?e:{each:e},n=Oi(t.ease),r=t.from||0,a=parseFloat(t.base)||0,s={},o=r>0&&r<1,l=isNaN(r)||o,c=t.axis,u=r,f=r;return yt(r)?u=f={center:.5,edges:.5,end:1}[r]||0:!o&&l&&(u=r[0],f=r[1]),function(d,h,E){var A=(E||t).length,p=s[A],m,g,T,N,v,C,x,_,M;if(!p){if(M=t.grid==="auto"?0:(t.grid||[1,mn])[1],!M){for(x=-mn;x<(x=E[M++].getBoundingClientRect().left)&&M<A;);M<A&&M--}for(p=s[A]=[],m=l?Math.min(M,A)*u-.5:r%M,g=M===mn?0:l?A*f/M-.5:r/M|0,x=0,_=mn,C=0;C<A;C++)T=C%M-m,N=g-(C/M|0),p[C]=v=c?Math.abs(c==="y"?N:T):Mu(T*T+N*N),v>x&&(x=v),v<_&&(_=v);r==="random"&&Hu(p),p.max=x-_,p.min=_,p.v=A=(parseFloat(t.amount)||parseFloat(t.each)*(M>A?A-1:c?c==="y"?A/M:M:Math.max(M,A/M))||0)*(r==="edges"?-1:1),p.b=A<0?a-A:a,p.u=Pt(t.amount||t.each)||0,n=n&&A<0?m_(n):n}return A=(p[d]-p.min)/p.max||0,ct(p.b+(n?n(A):A)*p.v)+p.u}},Io=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var r=ct(Math.round(parseFloat(n)/e)*e*t);return(r-r%1)/t+($n(n)?0:Pt(n))}},ku=function(e,t){var n=Ft(e),r,a;return!n&&Fn(e)&&(r=n=e.radius||mn,e.values?(e=An(e.values),(a=!$n(e[0]))&&(r*=r)):e=Io(e.increment)),_i(t,n?mt(e)?function(s){return a=e(s),Math.abs(a-s)<=r?a:s}:function(s){for(var o=parseFloat(a?s.x:s),l=parseFloat(a?s.y:0),c=mn,u=0,f=e.length,d,h;f--;)a?(d=e[f].x-o,h=e[f].y-l,d=d*d+h*h):d=Math.abs(e[f]-o),d<c&&(c=d,u=f);return u=!r||c<=r?e[u]:s,a||u===s||$n(s)?u:u+Pt(s)}:Io(e))},Wu=function(e,t,n,r){return _i(Ft(e)?!t:n===!0?!!(n=0):!r,function(){return Ft(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(r=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*r)/r})},i_=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(r){return t.reduce(function(a,s){return s(a)},r)}},r_=function(e,t){return function(n){return e(parseFloat(n))+(t||Pt(n))}},a_=function(e,t,n){return Xu(e,t,0,1,n)},Yu=function(e,t,n){return _i(n,function(r){return e[~~t(r)]})},s_=function i(e,t,n){var r=t-e;return Ft(e)?Yu(e,i(0,e.length),t):_i(n,function(a){return(r+(a-e)%r)%r+e})},o_=function i(e,t,n){var r=t-e,a=r*2;return Ft(e)?Yu(e,i(0,e.length-1),t):_i(n,function(s){return s=(a+(s-e)%a)%a||0,e+(s>r?a-s:s)})},Xr=function(e){return e.replace(VE,function(t){var n=t.indexOf("[")+1,r=t.substring(n||7,n?t.indexOf("]"):t.length-1).split(HE);return Wu(n?r:+r[0],n?0:+r[1],+r[2]||1e-5)})},Xu=function(e,t,n,r,a){var s=t-e,o=r-n;return _i(a,function(l){return n+((l-e)/s*o||0)})},l_=function i(e,t,n,r){var a=isNaN(e+t)?0:function(h){return(1-h)*e+h*t};if(!a){var s=yt(e),o={},l,c,u,f,d;if(n===!0&&(r=1)&&(n=null),s)e={p:e},t={p:t};else if(Ft(e)&&!Ft(t)){for(u=[],f=e.length,d=f-2,c=1;c<f;c++)u.push(i(e[c-1],e[c]));f--,a=function(E){E*=f;var A=Math.min(d,~~E);return u[A](E-A)},n=t}else r||(e=fr(Ft(e)?[]:{},e));if(!u){for(l in t)$o.call(o,e,l,"get",t[l]);a=function(E){return el(E,o)||(s?e.p:e)}}}return _i(n,a)},Nc=function(e,t,n){var r=e.labels,a=mn,s,o,l;for(s in r)o=r[s]-t,o<0==!!n&&o&&a>(o=Math.abs(o))&&(l=s,a=o);return l},nn=function(e,t,n){var r=e.vars,a=r[t],s=st,o=e._ctx,l,c,u;if(a)return l=r[t+"Params"],c=r.callbackScope||e,n&&fi.length&&qa(),o&&(st=o),u=l?a.apply(c,l):a.call(c),st=s,u},Fr=function(e){return mi(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Dt),e.progress()<1&&nn(e,"onInterrupt"),e},ar,qu=[],Zu=function(e){if(e)if(e=!e.name&&e.default||e,ko()||e.headless){var t=e.name,n=mt(e),r=t&&!n&&e.init?function(){this._props=[]}:e,a={init:Yr,render:el,add:$o,kill:C_,modifier:M_,rawVars:0},s={targetTest:0,get:0,getSetter:Qo,aliases:{},register:0};if(mr(),e!==r){if(en[t])return;ln(r,ln(Za(e,a),s)),fr(r.prototype,fr(a,Za(e,s))),en[r.prop=t]=r,e.targetTest&&(Ua.push(r),Xo[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}Du(t,r),e.register&&e.register(Zt,r,Xt)}else qu.push(e)},tt=255,Gr={aqua:[0,tt,tt],lime:[0,tt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,tt],navy:[0,0,128],white:[tt,tt,tt],olive:[128,128,0],yellow:[tt,tt,0],orange:[tt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[tt,0,0],pink:[tt,192,203],cyan:[0,tt,tt],transparent:[tt,tt,tt,0]},Ks=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*tt+.5|0},Ku=function(e,t,n){var r=e?$n(e)?[e>>16,e>>8&tt,e&tt]:0:Gr.black,a,s,o,l,c,u,f,d,h,E;if(!r){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),Gr[e])r=Gr[e];else if(e.charAt(0)==="#"){if(e.length<6&&(a=e.charAt(1),s=e.charAt(2),o=e.charAt(3),e="#"+a+a+s+s+o+o+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return r=parseInt(e.substr(1,6),16),[r>>16,r>>8&tt,r&tt,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),r=[e>>16,e>>8&tt,e&tt]}else if(e.substr(0,3)==="hsl"){if(r=E=e.match(_c),!t)l=+r[0]%360/360,c=+r[1]/100,u=+r[2]/100,s=u<=.5?u*(c+1):u+c-u*c,a=u*2-s,r.length>3&&(r[3]*=1),r[0]=Ks(l+1/3,a,s),r[1]=Ks(l,a,s),r[2]=Ks(l-1/3,a,s);else if(~e.indexOf("="))return r=e.match(Ru),n&&r.length<4&&(r[3]=1),r}else r=e.match(_c)||Gr.transparent;r=r.map(Number)}return t&&!E&&(a=r[0]/tt,s=r[1]/tt,o=r[2]/tt,f=Math.max(a,s,o),d=Math.min(a,s,o),u=(f+d)/2,f===d?l=c=0:(h=f-d,c=u>.5?h/(2-f-d):h/(f+d),l=f===a?(s-o)/h+(s<o?6:0):f===s?(o-a)/h+2:(a-s)/h+4,l*=60),r[0]=~~(l+.5),r[1]=~~(c*100+.5),r[2]=~~(u*100+.5)),n&&r.length<4&&(r[3]=1),r},$u=function(e){var t=[],n=[],r=-1;return e.split(hi).forEach(function(a){var s=a.match(rr)||[];t.push.apply(t,s),n.push(r+=s.length+1)}),t.c=n,t},Mc=function(e,t,n){var r="",a=(e+r).match(hi),s=t?"hsla(":"rgba(",o=0,l,c,u,f;if(!a)return e;if(a=a.map(function(d){return(d=Ku(d,t,1))&&s+(t?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(u=$u(e),l=n.c,l.join(r)!==u.c.join(r)))for(c=e.replace(hi,"1").split(rr),f=c.length-1;o<f;o++)r+=c[o]+(~l.indexOf(o)?a.shift()||s+"0,0,0,0)":(u.length?u:a.length?a:n).shift());if(!c)for(c=e.split(hi),f=c.length-1;o<f;o++)r+=c[o]+a[o];return r+c[f]},hi=(function(){var i="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in Gr)i+="|"+e+"\\b";return new RegExp(i+")","gi")})(),c_=/hsl[a]?\(/,ju=function(e){var t=e.join(" "),n;if(hi.lastIndex=0,hi.test(t))return n=c_.test(t),e[1]=Mc(e[1],n),e[0]=Mc(e[0],n,$u(e[1])),!0},qr,tn=(function(){var i=Date.now,e=500,t=33,n=i(),r=n,a=1e3/240,s=a,o=[],l,c,u,f,d,h,E=function A(p){var m=i()-r,g=p===!0,T,N,v,C;if((m>e||m<0)&&(n+=m-t),r+=m,v=r-n,T=v-s,(T>0||g)&&(C=++f.frame,d=v-f.time*1e3,f.time=v=v/1e3,s+=T+(T>=a?4:a-T),N=1),g||(l=c(A)),N)for(h=0;h<o.length;h++)o[h](v,d,C,p)};return f={time:0,frame:0,tick:function(){E(!0)},deltaRatio:function(p){return d/(1e3/(p||60))},wake:function(){xu&&(!ho&&ko()&&(Dn=ho=window,Wo=Dn.document||{},on.gsap=Zt,(Dn.gsapVersions||(Dn.gsapVersions=[])).push(Zt.version),yu(Xa||Dn.GreenSockGlobals||!Dn.gsap&&Dn||{}),qu.forEach(Zu)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&f.sleep(),c=u||function(p){return setTimeout(p,s-f.time*1e3+1|0)},qr=1,E(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),qr=0,c=Yr},lagSmoothing:function(p,m){e=p||1/0,t=Math.min(m||33,e)},fps:function(p){a=1e3/(p||240),s=f.time*1e3+a},add:function(p,m,g){var T=m?function(N,v,C,x){p(N,v,C,x),f.remove(T)}:p;return f.remove(p),o[g?"unshift":"push"](T),mr(),T},remove:function(p,m){~(m=o.indexOf(p))&&o.splice(m,1)&&h>=m&&h--},_listeners:o},f})(),mr=function(){return!qr&&tn.wake()},We={},u_=/^[\d.\-M][\d.\-,\s]/,d_=/["']/g,f_=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),r=n[0],a=1,s=n.length,o,l,c;a<s;a++)l=n[a],o=a!==s-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),t[r]=isNaN(c)?c.replace(d_,"").trim():+c,r=l.substr(o+1).trim();return t},h_=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),r=e.indexOf("(",t);return e.substring(t,~r&&r<n?e.indexOf(")",n+1):n)},p_=function(e){var t=(e+"").split("("),n=We[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[f_(t[1])]:h_(e).split(",").map(Ou)):We._CE&&u_.test(e)?We._CE("",e):n},m_=function(e){return function(t){return 1-e(1-t)}},Oi=function(e,t){return e&&(mt(e)?e:We[e]||p_(e))||t},Vi=function(e,t,n,r){n===void 0&&(n=function(l){return 1-t(1-l)}),r===void 0&&(r=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var a={easeIn:t,easeOut:n,easeInOut:r},s;return Yt(e,function(o){We[o]=on[o]=a,We[s=o.toLowerCase()]=n;for(var l in a)We[s+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=We[o+"."+l]=a[l]}),a},Ju=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},$s=function i(e,t,n){var r=t>=1?t:1,a=(n||(e?.3:.45))/(t<1?t:1),s=a/fo*(Math.asin(1/r)||0),o=function(u){return u===1?1:r*Math.pow(2,-10*u)*BE((u-s)*a)+1},l=e==="out"?o:e==="in"?function(c){return 1-o(1-c)}:Ju(o);return a=fo/a,l.config=function(c,u){return i(e,c,u)},l},js=function i(e,t){t===void 0&&(t=1.70158);var n=function(s){return s?--s*s*((t+1)*s+t)+1:0},r=e==="out"?n:e==="in"?function(a){return 1-n(1-a)}:Ju(n);return r.config=function(a){return i(e,a)},r};Yt("Linear,Quad,Cubic,Quart,Quint,Strong",function(i,e){var t=e<5?e+1:e;Vi(i+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});We.Linear.easeNone=We.none=We.Linear.easeIn;Vi("Elastic",$s("in"),$s("out"),$s());(function(i,e){var t=1/e,n=2*t,r=2.5*t,a=function(o){return o<t?i*o*o:o<n?i*Math.pow(o-1.5/e,2)+.75:o<r?i*(o-=2.25/e)*o+.9375:i*Math.pow(o-2.625/e,2)+.984375};Vi("Bounce",function(s){return 1-a(1-s)},a)})(7.5625,2.75);Vi("Expo",function(i){return Math.pow(2,10*(i-1))*i+i*i*i*i*i*i*(1-i)});Vi("Circ",function(i){return-(Mu(1-i*i)-1)});Vi("Sine",function(i){return i===1?1:-GE(i*UE)+1});Vi("Back",js("in"),js("out"),js());We.SteppedEase=We.steps=on.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,r=e+(t?0:1),a=t?1:0,s=1-nt;return function(o){return((r*ia(0,s,o)|0)+a)*n}}};kr.ease=We["quad.out"];Yt("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(i){return qo+=i+","+i+"Params,"});var Qu=function(e,t){this.id=FE++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:wu,this.set=t?t.getSetter:Qo},Zr=(function(){function i(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,pr(this,+t.duration,1,1),this.data=t.data,st&&(this._ctx=st,st.data.push(this)),qr||tn.wake()}var e=i.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,pr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,r){if(mr(),!arguments.length)return this._tTime;var a=this._dp;if(a&&a.smoothChildTiming&&this._ts){for(us(this,n),!a._dp||a.parent||Fu(a,this);a&&a.parent;)a.parent._time!==a._start+(a._ts>=0?a._tTime/a._ts:(a.totalDuration()-a._tTime)/-a._ts)&&a.totalTime(a._tTime,!0),a=a.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&wn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!r||this._initted&&Math.abs(this._zTime)===nt||!this._initted&&this._dur&&n||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Lu(this,n,r)),this},e.time=function(n,r){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Sc(this))%(this._dur+this._rDelay)||(n?this._dur:0),r):this._time},e.totalProgress=function(n,r){return arguments.length?this.totalTime(this.totalDuration()*n,r):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},e.progress=function(n,r){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Sc(this),r):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,r){var a=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*a,r):this._repeat?hr(this._tTime,a)+1:1},e.timeScale=function(n,r){if(!arguments.length)return this._rts===-nt?0:this._rts;if(this._rts===n)return this;var a=this.parent&&this._ts?Ka(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-nt?0:this._rts,this.totalTime(ia(-Math.abs(this._delay),this.totalDuration(),a),r!==!1),cs(this),KE(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(mr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==nt&&(this._tTime-=nt)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=ct(n);var r=this.parent||this._dp;return r&&(r._sort||!this.parent)&&wn(r,this,this._start-this._delay),this}return this._start},e.endTime=function(n){return this._start+(Wt(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var r=this.parent||this._dp;return r?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Ka(r.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=YE);var r=Dt;return Dt=n,Ko(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Dt=r,this},e.globalTime=function(n){for(var r=this,a=arguments.length?n:r.rawTime();r;)a=r._start+a/(Math.abs(r._ts)||1),r=r._dp;return!this.parent&&this._sat?this._sat.globalTime(n):a},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Tc(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var r=this._time;return this._rDelay=n,Tc(this),r?this.time(r):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,r){return this.totalTime(dn(this,n),Wt(r))},e.restart=function(n,r){return this.play().totalTime(n?-this._delay:0,Wt(r)),this._dur||(this._zTime=-nt),this},e.play=function(n,r){return n!=null&&this.seek(n,r),this.reversed(!1).paused(!1)},e.reverse=function(n,r){return n!=null&&this.seek(n||this.totalDuration(),r),this.reversed(!0).paused(!1)},e.pause=function(n,r){return n!=null&&this.seek(n,r),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-nt:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-nt,this},e.isActive=function(){var n=this.parent||this._dp,r=this._start,a;return!!(!n||this._ts&&this._initted&&n.isActive()&&(a=n.rawTime(!0))>=r&&a<this.endTime(!0)-nt)},e.eventCallback=function(n,r,a){var s=this.vars;return arguments.length>1?(r?(s[n]=r,a&&(s[n+"Params"]=a),n==="onUpdate"&&(this._onUpdate=r)):delete s[n],this):s[n]},e.then=function(n){var r=this,a=r._prom;return new Promise(function(s){var o=mt(n)?n:Pu,l=function(){var u=r.then;r.then=null,a&&a(),mt(o)&&(o=o(r))&&(o.then||o===r)&&(r.then=u),s(o),r.then=u};r._initted&&r.totalProgress()===1&&r._ts>=0||!r._tTime&&r._ts<0?l():r._prom=l})},e.kill=function(){Fr(this)},i})();ln(Zr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-nt,_prom:0,_ps:!1,_rts:1});var kt=(function(i){Nu(e,i);function e(n,r){var a;return n===void 0&&(n={}),a=i.call(this,n)||this,a.labels={},a.smoothChildTiming=!!n.smoothChildTiming,a.autoRemoveChildren=!!n.autoRemoveChildren,a._sort=Wt(n.sortChildren),ut&&wn(n.parent||ut,Yn(a),r),n.reversed&&a.reverse(),n.paused&&a.paused(!0),n.scrollTrigger&&Gu(Yn(a),n.scrollTrigger),a}var t=e.prototype;return t.to=function(r,a,s){return Hr(0,arguments,this),this},t.from=function(r,a,s){return Hr(1,arguments,this),this},t.fromTo=function(r,a,s,o){return Hr(2,arguments,this),this},t.set=function(r,a,s){return a.duration=0,a.parent=this,Vr(a).repeatDelay||(a.repeat=0),a.immediateRender=!!a.immediateRender,new Tt(r,a,dn(this,s),1),this},t.call=function(r,a,s){return wn(this,Tt.delayedCall(0,r,a),s)},t.staggerTo=function(r,a,s,o,l,c,u){return s.duration=a,s.stagger=s.stagger||o,s.onComplete=c,s.onCompleteParams=u,s.parent=this,new Tt(r,s,dn(this,l)),this},t.staggerFrom=function(r,a,s,o,l,c,u){return s.runBackwards=1,Vr(s).immediateRender=Wt(s.immediateRender),this.staggerTo(r,a,s,o,l,c,u)},t.staggerFromTo=function(r,a,s,o,l,c,u,f){return o.startAt=s,Vr(o).immediateRender=Wt(o.immediateRender),this.staggerTo(r,a,o,l,c,u,f)},t.render=function(r,a,s){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=r<=0?0:ct(r),f=this._zTime<0!=r<0&&(this._initted||!c),d,h,E,A,p,m,g,T,N,v,C,x;if(this!==ut&&u>l&&r>=0&&(u=l),u!==this._tTime||s||f){if(o!==this._time&&c&&(u+=this._time-o,r+=this._time-o),d=u,N=this._start,T=this._ts,m=!T,f&&(c||(o=this._zTime),(r||!a)&&(this._zTime=r)),this._repeat){if(C=this._yoyo,p=c+this._rDelay,this._repeat<-1&&r<0)return this.totalTime(p*100+r,a,s);if(d=ct(u%p),u===l?(A=this._repeat,d=c):(v=ct(u/p),A=~~v,A&&A===v&&(d=c,A--),d>c&&(d=c)),v=hr(this._tTime,p),!o&&this._tTime&&v!==A&&this._tTime-v*p-this._dur<=0&&(v=A),C&&A&1&&(d=c-d,x=1),A!==v&&!this._lock){var _=C&&v&1,M=_===(C&&A&1);if(A<v&&(_=!_),o=_?0:u%c?c:u,this._lock=1,this.render(o||(x?0:ct(A*p)),a,!c)._lock=0,this._tTime=u,!a&&this.parent&&nn(this,"onRepeat"),this.vars.repeatRefresh&&!x&&(this.invalidate()._lock=1,v=A),o&&o!==this._time||m!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,M&&(this._lock=2,o=_?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!x&&this.invalidate()),this._lock=0,!this._ts&&!m)return this}}if(this._hasPause&&!this._forcing&&this._lock<2&&(g=QE(this,ct(o),ct(d)),g&&(u-=d-(d=g._start))),this._tTime=u,this._time=d,this._act=!!T,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=r,o=0),!o&&u&&c&&!a&&!v&&(nn(this,"onStart"),this._tTime!==u))return this;if(d>=o&&r>=0)for(h=this._first;h;){if(E=h._next,(h._act||d>=h._start)&&h._ts&&g!==h){if(h.parent!==this)return this.render(r,a,s);if(h.render(h._ts>0?(d-h._start)*h._ts:(h._dirty?h.totalDuration():h._tDur)+(d-h._start)*h._ts,a,s),d!==this._time||!this._ts&&!m){g=0,E&&(u+=this._zTime=-nt);break}}h=E}else{h=this._last;for(var D=r<0?r:d;h;){if(E=h._prev,(h._act||D<=h._end)&&h._ts&&g!==h){if(h.parent!==this)return this.render(r,a,s);if(h.render(h._ts>0?(D-h._start)*h._ts:(h._dirty?h.totalDuration():h._tDur)+(D-h._start)*h._ts,a,s||Dt&&Ko(h)),d!==this._time||!this._ts&&!m){g=0,E&&(u+=this._zTime=D?-nt:nt);break}}h=E}}if(g&&!a&&(this.pause(),g.render(d>=o?0:-nt)._zTime=d>=o?1:-1,this._ts))return this._start=N,cs(this),this.render(r,a,s);this._onUpdate&&!a&&nn(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(N===this._start||Math.abs(T)!==Math.abs(this._ts))&&(this._lock||((r||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&mi(this,1),!a&&!(r<0&&!o)&&(u||o||!l)&&(nn(this,u===l&&r>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(r,a){var s=this;if($n(a)||(a=dn(this,a,r)),!(r instanceof Zr)){if(Ft(r))return r.forEach(function(o){return s.add(o,a)}),this;if(yt(r))return this.addLabel(r,a);if(mt(r))r=Tt.delayedCall(0,r);else return this}return this!==r?wn(this,r,a):this},t.getChildren=function(r,a,s,o){r===void 0&&(r=!0),a===void 0&&(a=!0),s===void 0&&(s=!0),o===void 0&&(o=-mn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof Tt?a&&l.push(c):(s&&l.push(c),r&&l.push.apply(l,c.getChildren(!0,a,s)))),c=c._next;return l},t.getById=function(r){for(var a=this.getChildren(1,1,1),s=a.length;s--;)if(a[s].vars.id===r)return a[s]},t.remove=function(r){return yt(r)?this.removeLabel(r):mt(r)?this.killTweensOf(r):(r.parent===this&&ls(this,r),r===this._recent&&(this._recent=this._last),Li(this))},t.totalTime=function(r,a){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=ct(tn.time-(this._ts>0?r/this._ts:(this.totalDuration()-r)/-this._ts))),i.prototype.totalTime.call(this,r,a),this._forcing=0,this):this._tTime},t.addLabel=function(r,a){return this.labels[r]=dn(this,a),this},t.removeLabel=function(r){return delete this.labels[r],this},t.addPause=function(r,a,s){var o=Tt.delayedCall(0,a||Yr,s);return o.data="isPause",this._hasPause=1,wn(this,o,dn(this,r))},t.removePause=function(r){var a=this._first;for(r=dn(this,r);a;)a._start===r&&a.data==="isPause"&&mi(a),a=a._next},t.killTweensOf=function(r,a,s){for(var o=this.getTweensOf(r,s),l=o.length;l--;)ci!==o[l]&&o[l].kill(r,a);return this},t.getTweensOf=function(r,a){for(var s=[],o=An(r),l=this._first,c=$n(a),u;l;)l instanceof Tt?XE(l._targets,o)&&(c?(!ci||l._initted&&l._ts)&&l.globalTime(0)<=a&&l.globalTime(l.totalDuration())>a:!a||l.isActive())&&s.push(l):(u=l.getTweensOf(o,a)).length&&s.push.apply(s,u),l=l._next;return s},t.tweenTo=function(r,a){a=a||{};var s=this,o=dn(s,r),l=a,c=l.startAt,u=l.onStart,f=l.onStartParams,d=l.immediateRender,h,E=Tt.to(s,ln({ease:a.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:a.duration||Math.abs((o-(c&&"time"in c?c.time:s._time))/s.timeScale())||nt,onStart:function(){if(s.pause(),!h){var p=a.duration||Math.abs((o-(c&&"time"in c?c.time:s._time))/s.timeScale());E._dur!==p&&pr(E,p,0,1).render(E._time,!0,!0),h=1}u&&u.apply(E,f||[])}},a));return d?E.render(0):E},t.tweenFromTo=function(r,a,s){return this.tweenTo(a,ln({startAt:{time:dn(this,r)}},s))},t.recent=function(){return this._recent},t.nextLabel=function(r){return r===void 0&&(r=this._time),Nc(this,dn(this,r))},t.previousLabel=function(r){return r===void 0&&(r=this._time),Nc(this,dn(this,r),1)},t.currentLabel=function(r){return arguments.length?this.seek(r,!0):this.previousLabel(this._time+nt)},t.shiftChildren=function(r,a,s){s===void 0&&(s=0);var o=this._first,l=this.labels,c;for(r=ct(r);o;)o._start>=s&&(o._start+=r,o._end+=r),o=o._next;if(a)for(c in l)l[c]>=s&&(l[c]+=r);return Li(this)},t.invalidate=function(r){var a=this._first;for(this._lock=0;a;)a.invalidate(r),a=a._next;return i.prototype.invalidate.call(this,r)},t.clear=function(r){r===void 0&&(r=!0);for(var a=this._first,s;a;)s=a._next,this.remove(a),a=s;return this._dp&&(this._time=this._tTime=this._pTime=0),r&&(this.labels={}),Li(this)},t.totalDuration=function(r){var a=0,s=this,o=s._last,l=mn,c,u,f;if(arguments.length)return s.timeScale((s._repeat<0?s.duration():s.totalDuration())/(s.reversed()?-r:r));if(s._dirty){for(f=s.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&s._sort&&o._ts&&!s._lock?(s._lock=1,wn(s,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(a-=u,(!f&&!s._dp||f&&f.smoothChildTiming)&&(s._start+=ct(u/s._ts),s._time-=u,s._tTime-=u),s.shiftChildren(-u,!1,-1/0),l=0),o._end>a&&o._ts&&(a=o._end),o=c;pr(s,s===ut&&s._time>a?s._time:a,1,1),s._dirty=0}return s._tDur},e.updateRoot=function(r){if(ut._ts&&(Lu(ut,Ka(r,ut)),bu=tn.frame),tn.frame>=Ic){Ic+=sn.autoSleep||120;var a=ut._first;if((!a||!a._ts)&&sn.autoSleep&&tn._listeners.length<2){for(;a&&!a._ts;)a=a._next;a||tn.sleep()}}},e})(Zr);ln(kt.prototype,{_lock:0,_hasPause:0,_forcing:0});var A_=function(e,t,n,r,a,s,o){var l=new Xt(this._pt,e,t,0,1,ad,null,a),c=0,u=0,f,d,h,E,A,p,m,g;for(l.b=n,l.e=r,n+="",r+="",(m=~r.indexOf("random("))&&(r=Xr(r)),s&&(g=[n,r],s(g,e,t),n=g[0],r=g[1]),d=n.match(qs)||[];f=qs.exec(r);)E=f[0],A=r.substring(c,f.index),h?h=(h+1)%5:A.substr(-5)==="rgba("&&(h=1),E!==d[u++]&&(p=parseFloat(d[u-1])||0,l._pt={_next:l._pt,p:A||u===1?A:",",s:p,c:E.charAt(1)==="="?or(p,E)-p:parseFloat(E)-p,m:h&&h<4?Math.round:0},c=qs.lastIndex);return l.c=c<r.length?r.substring(c,r.length):"",l.fp=o,(vu.test(r)||m)&&(l.e=0),this._pt=l,l},$o=function(e,t,n,r,a,s,o,l,c,u){mt(r)&&(r=r(a||0,e,s));var f=e[t],d=n!=="get"?n:mt(f)?c?e[t.indexOf("set")||!mt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():f,h=mt(f)?c?S_:id:Jo,E;if(yt(r)&&(~r.indexOf("random(")&&(r=Xr(r)),r.charAt(1)==="="&&(E=or(d,r)+(Pt(d)||0),(E||E===0)&&(r=E))),!u||d!==r||go)return!isNaN(d*r)&&r!==""?(E=new Xt(this._pt,e,t,+d||0,r-(d||0),typeof f=="boolean"?N_:rd,0,h),c&&(E.fp=c),o&&E.modifier(o,this,e),this._pt=E):(!f&&!(t in e)&&Yo(t,r),A_.call(this,e,t,d,r,h,l||sn.stringFilter,c))},E_=function(e,t,n,r,a){if(mt(e)&&(e=zr(e,a,t,n,r)),!Fn(e)||e.style&&e.nodeType||Ft(e)||Cu(e))return yt(e)?zr(e,a,t,n,r):e;var s={},o;for(o in e)s[o]=zr(e[o],a,t,n,r);return s},ed=function(e,t,n,r,a,s){var o,l,c,u;if(en[e]&&(o=new en[e]).init(a,o.rawVars?t[e]:E_(t[e],r,a,s,n),n,r,s)!==!1&&(n._pt=l=new Xt(n._pt,a,e,0,1,o.render,o,0,o.priority),n!==ar))for(c=n._ptLookup[n._targets.indexOf(a)],u=o._props.length;u--;)c[o._props[u]]=l;return o},ci,go,jo=function i(e,t,n){var r=e.vars,a=r.ease,s=r.startAt,o=r.immediateRender,l=r.lazy,c=r.onUpdate,u=r.runBackwards,f=r.yoyoEase,d=r.keyframes,h=r.autoRevert,E=e._dur,A=e._startAt,p=e._targets,m=e.parent,g=m&&m.data==="nested"?m.vars.targets:p,T=e._overwrite==="auto"&&!Ho,N=e.timeline,v=r.easeReverse||f,C,x,_,M,D,y,P,z,W,w,B,U,$;if(N&&(!d||!a)&&(a="none"),e._ease=Oi(a,kr.ease),e._rEase=v&&(Oi(v)||e._ease),e._from=!N&&!!r.runBackwards,e._from&&(e.ratio=1),!N||d&&!r.stagger){if(z=p[0]?wi(p[0]).harness:0,U=z&&r[z.prop],C=Za(r,Xo),A&&(A._zTime<0&&A.progress(1),t<0&&u&&o&&!h?A.render(-1,!0):A.revert(u&&E?Pa:WE),A._lazy=0),s){if(mi(e._startAt=Tt.set(p,ln({data:"isStart",overwrite:!1,parent:m,immediateRender:!0,lazy:!A&&Wt(l),startAt:null,delay:0,onUpdate:c&&function(){return nn(e,"onUpdate")},stagger:0},s))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Dt||!o&&!h)&&e._startAt.revert(Pa),o&&E&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(u&&E&&!A){if(t&&(o=!1),_=ln({overwrite:!1,data:"isFromStart",lazy:o&&!A&&Wt(l),immediateRender:o,stagger:0,parent:m},C),U&&(_[z.prop]=U),mi(e._startAt=Tt.set(p,_)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Dt?e._startAt.revert(Pa):e._startAt.render(-1,!0)),e._zTime=t,!o)i(e._startAt,nt,nt);else if(!t)return}for(e._pt=e._ptCache=0,l=E&&Wt(l)||l&&!E,x=0;x<p.length;x++){if(D=p[x],P=D._gsap||Zo(p)[x]._gsap,e._ptLookup[x]=w={},po[P.id]&&fi.length&&qa(),B=g===p?x:g.indexOf(D),z&&(W=new z).init(D,U||C,e,B,g)!==!1&&(e._pt=M=new Xt(e._pt,D,W.name,0,1,W.render,W,0,W.priority),W._props.forEach(function(Q){w[Q]=M}),W.priority&&(y=1)),!z||U)for(_ in C)en[_]&&(W=ed(_,C,e,B,D,g))?W.priority&&(y=1):w[_]=M=$o.call(e,D,_,"get",C[_],B,g,0,r.stringFilter);e._op&&e._op[x]&&e.kill(D,e._op[x]),T&&e._pt&&(ci=e,ut.killTweensOf(D,w,e.globalTime(t)),$=!e.parent,ci=0),e._pt&&l&&(po[P.id]=1)}y&&sd(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!$,d&&t<=0&&N.render(mn,!0,!0)},__=function(e,t,n,r,a,s,o,l){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],u,f,d,h;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,h=e._targets.length;h--;){if(u=d[h][t],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==t&&u.fp!==t;)u=u._next;if(!u)return go=1,e.vars[t]="+=0",jo(e,o),go=0,l?Wr(t+" not eligible for reset. Try splitting into individual properties"):1;c.push(u)}for(h=c.length;h--;)f=c[h],u=f._pt||f,u.s=(r||r===0)&&!a?r:u.s+(r||0)+s*u.c,u.c=n-u.s,f.e&&(f.e=It(n)+Pt(f.e)),f.b&&(f.b=u.s+Pt(f.b))},I_=function(e,t){var n=e[0]?wi(e[0]).harness:0,r=n&&n.aliases,a,s,o,l;if(!r)return t;a=fr({},t);for(s in r)if(s in a)for(l=r[s].split(","),o=l.length;o--;)a[l[o]]=a[s];return a},g_=function(e,t,n,r){var a=t.ease||r||"power1.inOut",s,o;if(Ft(t))o=n[e]||(n[e]=[]),t.forEach(function(l,c){return o.push({t:c/(t.length-1)*100,v:l,e:a})});else for(s in t)o=n[s]||(n[s]=[]),s==="ease"||o.push({t:parseFloat(e),v:t[s],e:a})},zr=function(e,t,n,r,a){return mt(e)?e.call(t,n,r,a):yt(e)&&~e.indexOf("random(")?Xr(e):e},td=qo+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert",nd={};Yt(td+",id,stagger,delay,duration,paused,scrollTrigger",function(i){return nd[i]=1});var Tt=(function(i){Nu(e,i);function e(n,r,a,s){var o;typeof r=="number"&&(a.duration=r,r=a,a=null),o=i.call(this,s?r:Vr(r))||this;var l=o.vars,c=l.duration,u=l.delay,f=l.immediateRender,d=l.stagger,h=l.overwrite,E=l.keyframes,A=l.defaults,p=l.scrollTrigger,m=r.parent||ut,g=(Ft(n)||Cu(n)?$n(n[0]):"length"in r)?[n]:An(n),T,N,v,C,x,_,M,D;if(o._targets=g.length?Zo(g):Wr("GSAP target "+n+" not found. https://gsap.com",!sn.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=h,E||d||wa(c)||wa(u)){r=o.vars;var y=r.easeReverse||r.yoyoEase;if(T=o.timeline=new kt({data:"nested",defaults:A||{},targets:m&&m.data==="nested"?m.vars.targets:g}),T.kill(),T.parent=T._dp=Yn(o),T._start=0,d||wa(c)||wa(u)){if(C=g.length,M=d&&zu(d),Fn(d))for(x in d)~td.indexOf(x)&&(D||(D={}),D[x]=d[x]);for(N=0;N<C;N++)v=Za(r,nd),v.stagger=0,y&&(v.easeReverse=y),D&&fr(v,D),_=g[N],v.duration=+zr(c,Yn(o),N,_,g),v.delay=(+zr(u,Yn(o),N,_,g)||0)-o._delay,!d&&C===1&&v.delay&&(o._delay=u=v.delay,o._start+=u,v.delay=0),T.to(_,v,M?M(N,_,g):0),T._ease=We.none;T.duration()?c=u=0:o.timeline=0}else if(E){Vr(ln(T.vars.defaults,{ease:"none"})),T._ease=Oi(E.ease||r.ease||"none");var P=0,z,W,w;if(Ft(E))E.forEach(function(B){return T.to(g,B,">")}),T.duration();else{v={};for(x in E)x==="ease"||x==="easeEach"||g_(x,E[x],v,E.easeEach);for(x in v)for(z=v[x].sort(function(B,U){return B.t-U.t}),P=0,N=0;N<z.length;N++)W=z[N],w={ease:W.e,duration:(W.t-(N?z[N-1].t:0))/100*c},w[x]=W.v,T.to(g,w,P),P+=w.duration;T.duration()<c&&T.to({},{duration:c-T.duration()})}}c||o.duration(c=T.duration())}else o.timeline=0;return h===!0&&!Ho&&(ci=Yn(o),ut.killTweensOf(g),ci=0),wn(m,Yn(o),a),r.reversed&&o.reverse(),r.paused&&o.paused(!0),(f||!c&&!E&&o._start===ct(m._time)&&Wt(f)&&$E(Yn(o))&&m.data!=="nested")&&(o._tTime=-nt,o.render(Math.max(0,-u)||0)),p&&Gu(Yn(o),p),o}var t=e.prototype;return t.render=function(r,a,s){var o=this._time,l=this._tDur,c=this._dur,u=r<0,f=r>l-nt&&!u?l:r<nt?0:r,d,h,E,A,p,m,g,T;if(!c)JE(this,r,a,s);else if(f!==this._tTime||!r||s||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(d=f,T=this.timeline,this._repeat){if(A=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(A*100+r,a,s);if(d=ct(f%A),f===l?(E=this._repeat,d=c):(p=ct(f/A),E=~~p,E&&E===p?(d=c,E--):d>c&&(d=c)),m=this._yoyo&&E&1,m&&(d=c-d),p=hr(this._tTime,A),d===o&&!s&&this._initted&&E===p)return this._tTime=f,this;E!==p&&this.vars.repeatRefresh&&!m&&!this._lock&&d!==A&&this._initted&&(this._lock=s=1,this.render(ct(A*E),!0).invalidate()._lock=0)}if(!this._initted){if(Bu(this,u?r:d,s,a,f))return this._tTime=0,this;if(o!==this._time&&!(s&&this.vars.repeatRefresh&&E!==p))return this;if(c!==this._dur)return this.render(r,a,s)}if(this._rEase){var N=d<o;if(N!==this._inv){var v=N?o:c-o;this._inv=N,this._from&&(this.ratio=1-this.ratio),this._invRatio=this.ratio,this._invTime=o,this._invRecip=v?(N?-1:1)/v:0,this._invScale=N?-this.ratio:1-this.ratio,this._invEase=N?this._rEase:this._ease}this.ratio=g=this._invRatio+this._invScale*this._invEase((d-this._invTime)*this._invRecip)}else this.ratio=g=this._ease(d/c);if(this._from&&(this.ratio=g=1-g),this._tTime=f,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),!o&&f&&!a&&!p&&(nn(this,"onStart"),this._tTime!==f))return this;for(h=this._pt;h;)h.r(g,h.d),h=h._next;T&&T.render(r<0?r:T._dur*T._ease(d/this._dur),a,s)||this._startAt&&(this._zTime=r),this._onUpdate&&!a&&(u&&mo(this,r,a,s),nn(this,"onUpdate")),this._repeat&&E!==p&&this.vars.onRepeat&&!a&&this.parent&&nn(this,"onRepeat"),(f===this._tDur||!f)&&this._tTime===f&&(u&&!this._onUpdate&&mo(this,r,!0,!0),(r||!c)&&(f===this._tDur&&this._ts>0||!f&&this._ts<0)&&mi(this,1),!a&&!(u&&!o)&&(f||o||m)&&(nn(this,f===l?"onComplete":"onReverseComplete",!0),this._prom&&!(f<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(r){return(!r||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(r),i.prototype.invalidate.call(this,r)},t.resetTo=function(r,a,s,o,l){qr||tn.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||jo(this,c),u=this._ease(c/this._dur),__(this,r,a,s,o,u,c,l)?this.resetTo(r,a,s,o,1):(us(this,0),this.parent||Uu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(r,a){if(a===void 0&&(a="all"),!r&&(!a||a==="all"))return this._lazy=this._pt=0,this.parent?Fr(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Dt),this;if(this.timeline){var s=this.timeline.totalDuration();return this.timeline.killTweensOf(r,a,ci&&ci.vars.overwrite!==!0)._first||Fr(this),this.parent&&s!==this.timeline.totalDuration()&&pr(this,this._dur*this.timeline._tDur/s,0,1),this}var o=this._targets,l=r?An(r):o,c=this._ptLookup,u=this._pt,f,d,h,E,A,p,m;if((!a||a==="all")&&ZE(o,l))return a==="all"&&(this._pt=0),Fr(this);for(f=this._op=this._op||[],a!=="all"&&(yt(a)&&(A={},Yt(a,function(g){return A[g]=1}),a=A),a=I_(o,a)),m=o.length;m--;)if(~l.indexOf(o[m])){d=c[m],a==="all"?(f[m]=a,E=d,h={}):(h=f[m]=f[m]||{},E=a);for(A in E)p=d&&d[A],p&&((!("kill"in p.d)||p.d.kill(A)===!0)&&ls(this,p,"_pt"),delete d[A]),h!=="all"&&(h[A]=1)}return this._initted&&!this._pt&&u&&Fr(this),this},e.to=function(r,a){return new e(r,a,arguments[2])},e.from=function(r,a){return Hr(1,arguments)},e.delayedCall=function(r,a,s,o){return new e(a,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:r,onComplete:a,onReverseComplete:a,onCompleteParams:s,onReverseCompleteParams:s,callbackScope:o})},e.fromTo=function(r,a,s){return Hr(2,arguments)},e.set=function(r,a){return a.duration=0,a.repeatDelay||(a.repeat=0),new e(r,a)},e.killTweensOf=function(r,a,s){return ut.killTweensOf(r,a,s)},e})(Zr);ln(Tt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Yt("staggerTo,staggerFrom,staggerFromTo",function(i){Tt[i]=function(){var e=new kt,t=Eo.call(arguments,0);return t.splice(i==="staggerFromTo"?5:4,0,0),e[i].apply(e,t)}});var Jo=function(e,t,n){return e[t]=n},id=function(e,t,n){return e[t](n)},S_=function(e,t,n,r){return e[t](r.fp,n)},T_=function(e,t,n){return e.setAttribute(t,n)},Qo=function(e,t){return mt(e[t])?id:zo(e[t])&&e.setAttribute?T_:Jo},rd=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},N_=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},ad=function(e,t){var n=t._pt,r="";if(!e&&t.b)r=t.b;else if(e===1&&t.e)r=t.e;else{for(;n;)r=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+r,n=n._next;r+=t.c}t.set(t.t,t.p,r,t)},el=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},M_=function(e,t,n,r){for(var a=this._pt,s;a;)s=a._next,a.p===r&&a.modifier(e,t,n),a=s},C_=function(e){for(var t=this._pt,n,r;t;)r=t._next,t.p===e&&!t.op||t.op===e?ls(this,t,"_pt"):t.dep||(n=1),t=r;return!n},R_=function(e,t,n,r){r.mSet(e,t,r.m.call(r.tween,n,r.mt),r)},sd=function(e){for(var t=e._pt,n,r,a,s;t;){for(n=t._next,r=a;r&&r.pr>t.pr;)r=r._next;(t._prev=r?r._prev:s)?t._prev._next=t:a=t,(t._next=r)?r._prev=t:s=t,t=n}e._pt=a},Xt=(function(){function i(t,n,r,a,s,o,l,c,u){this.t=n,this.s=a,this.c=s,this.p=r,this.r=o||rd,this.d=l||this,this.set=c||Jo,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=i.prototype;return e.modifier=function(n,r,a){this.mSet=this.mSet||this.set,this.set=R_,this.m=n,this.mt=a,this.tween=r},i})();Yt(qo+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse",function(i){return Xo[i]=1});on.TweenMax=on.TweenLite=Tt;on.TimelineLite=on.TimelineMax=kt;ut=new kt({sortChildren:!1,defaults:kr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});sn.stringFilter=ju;var Pi=[],Fa={},v_=[],Cc=0,x_=0,Js=function(e){return(Fa[e]||v_).map(function(t){return t()})},So=function(){var e=Date.now(),t=[];e-Cc>2&&(Js("matchMediaInit"),Pi.forEach(function(n){var r=n.queries,a=n.conditions,s,o,l,c;for(o in r)s=Dn.matchMedia(r[o]).matches,s&&(l=1),s!==a[o]&&(a[o]=s,c=1);c&&(n.revert(),l&&t.push(n))}),Js("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(r){return n.add(null,r)})}),Cc=e,Js("matchMedia"))},od=(function(){function i(t,n){this.selector=n&&_o(n),this.data=[],this._r=[],this.isReverted=!1,this.id=x_++,t&&this.add(t)}var e=i.prototype;return e.add=function(n,r,a){mt(n)&&(a=r,r=n,n=mt);var s=this,o=function(){var c=st,u=s.selector,f;return c&&c!==s&&c.data.push(s),a&&(s.selector=_o(a)),st=s,f=r.apply(s,arguments),mt(f)&&s._r.push(f),st=c,s.selector=u,s.isReverted=!1,f};return s.last=o,n===mt?o(s,function(l){return s.add(null,l)}):n?s[n]=o:o},e.ignore=function(n){var r=st;st=null,n(this),st=r},e.getTweens=function(){var n=[];return this.data.forEach(function(r){return r instanceof i?n.push.apply(n,r.getTweens()):r instanceof Tt&&!(r.parent&&r.parent.data==="nested")&&n.push(r)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,r){var a=this;if(n?(function(){for(var o=a.getTweens(),l=a.data.length,c;l--;)c=a.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return o.splice(o.indexOf(u),1)}));for(o.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,f){return f.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=a.data.length;l--;)c=a.data[l],c instanceof kt?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof Tt)&&c.revert&&c.revert(n);a._r.forEach(function(u){return u(n,a)}),a.isReverted=!0})():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),r)for(var s=Pi.length;s--;)Pi[s].id===this.id&&Pi.splice(s,1)},e.revert=function(n){this.kill(n||{})},i})(),y_=(function(){function i(t){this.contexts=[],this.scope=t,st&&st.data.push(this)}var e=i.prototype;return e.add=function(n,r,a){Fn(n)||(n={matches:n});var s=new od(0,a||this.scope),o=s.conditions={},l,c,u;st&&!s.selector&&(s.selector=st.selector),this.contexts.push(s),r=s.add("onMatch",r),s.queries=n;for(c in n)c==="all"?u=1:(l=Dn.matchMedia(n[c]),l&&(Pi.indexOf(s)<0&&Pi.push(s),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(So):l.addEventListener("change",So)));return u&&r(s,function(f){return s.add(null,f)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(r){return r.kill(n,!0)})},i})(),$a={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(r){return Zu(r)})},timeline:function(e){return new kt(e)},getTweensOf:function(e,t){return ut.getTweensOf(e,t)},getProperty:function(e,t,n,r){yt(e)&&(e=An(e)[0]);var a=wi(e||{}).get,s=n?Pu:Ou;return n==="native"&&(n=""),e&&(t?s((en[t]&&en[t].get||a)(e,t,n,r)):function(o,l,c){return s((en[o]&&en[o].get||a)(e,o,l,c))})},quickSetter:function(e,t,n){if(e=An(e),e.length>1){var r=e.map(function(u){return Zt.quickSetter(u,t,n)}),a=r.length;return function(u){for(var f=a;f--;)r[f](u)}}e=e[0]||{};var s=en[t],o=wi(e),l=o.harness&&(o.harness.aliases||{})[t]||t,c=s?function(u){var f=new s;ar._pt=0,f.init(e,n?u+n:u,ar,0,[e]),f.render(1,f),ar._pt&&el(1,ar)}:o.set(e,l);return s?c:function(u){return c(e,l,n?u+n:u,o,1)}},quickTo:function(e,t,n){var r,a=Zt.to(e,ln((r={},r[t]="+=0.1",r.paused=!0,r.stagger=0,r),n||{})),s=function(l,c,u){return a.resetTo(t,l,c,u)};return s.tween=a,s},isTweening:function(e){return ut.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Oi(e.ease,kr.ease)),gc(kr,e||{})},config:function(e){return gc(sn,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,r=e.plugins,a=e.defaults,s=e.extendTimeline;(r||"").split(",").forEach(function(o){return o&&!en[o]&&!on[o]&&Wr(t+" effect requires "+o+" plugin.")}),Zs[t]=function(o,l,c){return n(An(o),ln(l||{},a),c)},s&&(kt.prototype[t]=function(o,l,c){return this.add(Zs[t](o,Fn(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){We[e]=Oi(t)},parseEase:function(e,t){return arguments.length?Oi(e,t):We},getById:function(e){return ut.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new kt(e),r,a;for(n.smoothChildTiming=Wt(e.smoothChildTiming),ut.remove(n),n._dp=0,n._time=n._tTime=ut._time,r=ut._first;r;)a=r._next,(t||!(!r._dur&&r instanceof Tt&&r.vars.onComplete===r._targets[0]))&&wn(n,r,r._start-r._delay),r=a;return wn(ut,n,0),n},context:function(e,t){return e?new od(e,t):st},matchMedia:function(e){return new y_(e)},matchMediaRefresh:function(){return Pi.forEach(function(e){var t=e.conditions,n,r;for(r in t)t[r]&&(t[r]=!1,n=1);n&&e.revert()})||So()},addEventListener:function(e,t){var n=Fa[e]||(Fa[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Fa[e],r=n&&n.indexOf(t);r>=0&&n.splice(r,1)},utils:{wrap:s_,wrapYoyo:o_,distribute:zu,random:Wu,snap:ku,normalize:a_,getUnit:Pt,clamp:t_,splitColor:Ku,toArray:An,selector:_o,mapRange:Xu,pipe:i_,unitize:r_,interpolate:l_,shuffle:Hu},install:yu,effects:Zs,ticker:tn,updateRoot:kt.updateRoot,plugins:en,globalTimeline:ut,core:{PropTween:Xt,globals:Du,Tween:Tt,Timeline:kt,Animation:Zr,getCache:wi,_removeLinkedListItem:ls,reverting:function(){return Dt},context:function(e){return e&&st&&(st.data.push(e),e._ctx=st),st},suppressOverwrites:function(e){return Ho=e}}};Yt("to,from,fromTo,delayedCall,set,killTweensOf",function(i){return $a[i]=Tt[i]});tn.add(kt.updateRoot);ar=$a.to({},{duration:0});var D_=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},b_=function(e,t){var n=e._targets,r,a,s;for(r in t)for(a=n.length;a--;)s=e._ptLookup[a][r],s&&(s=s.d)&&(s._pt&&(s=D_(s,r)),s&&s.modifier&&s.modifier(t[r],e,n[a],r))},Qs=function(e,t){return{name:e,headless:1,rawVars:1,init:function(r,a,s){s._onInit=function(o){var l,c;if(yt(a)&&(l={},Yt(a,function(u){return l[u]=1}),a=l),t){l={};for(c in a)l[c]=t(a[c]);a=l}b_(o,a)}}}},Zt=$a.registerPlugin({name:"attr",init:function(e,t,n,r,a){var s,o,l;this.tween=n;for(s in t)l=e.getAttribute(s)||"",o=this.add(e,"setAttribute",(l||0)+"",t[s],r,a,0,0,s),o.op=s,o.b=l,this._props.push(s)},render:function(e,t){for(var n=t._pt;n;)Dt?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Qs("roundProps",Io),Qs("modifiers"),Qs("snap",ku))||$a;Tt.version=kt.version=Zt.version="3.15.0";xu=1;ko()&&mr();We.Power0;We.Power1;We.Power2;We.Power3;We.Power4;We.Linear;We.Quad;We.Cubic;We.Quart;We.Quint;We.Strong;We.Elastic;We.Back;We.SteppedEase;We.Bounce;We.Sine;We.Expo;We.Circ;/*!
 * CSSPlugin 3.15.0
 * https://gsap.com
 *
...
`,Cn=document.getElementById("globe-canvas"),Ii=new PE({canvas:Cn,antialias:!0,alpha:!0});Ii.setPixelRatio(Math.min(window.devicePixelRatio,2));Ii.setSize(window.innerWidth,window.innerHeight);Ii.setClearColor(0,0);Ii.toneMapping=4;Ii.toneMappingExposure=1.3;const fs=new Ef,xt=new hn(45,window.innerWidth/window.innerHeight,.1,100),Ir=2;function Cd(){const i=window.innerWidth/window.innerHeight;return i<.6?{z:11.5,y:0}:i<.85?{z:8.5,y:0}:i<1.2?{z:7.5,y:0}:{z:6.5,y:0}}function yI(i){const e=Math.asin(Math.min(.999,Ir/i));return Math.tan(e)/Math.tan(xt.fov*Math.PI/360)*(window.innerHeight/2)}function al(i){const e=window.innerWidth,t=window.innerHeight,n=24;xt.clearViewOffset();const r=document.getElementById("left-hero");if(r){const a=r.getBoundingClientRect(),s=yI(i);let o=0,l=0;if(e/t>=1.05){const c=a.right+n-(e/2-s),u=Math.max(0,e-n-(e/2+s));o=Math.min(Math.max(0,c),u)}else{const c=a.bottom+n-(t/2-s),u=Math.max(0,t-n-(t/2+s));l=Math.min(Math.max(0,c),u)}(o||l)&&xt.setViewOffset(e,t,-o,-l,e,t)}xt.updateProjectionMatrix()}function Rd(){const{z:i,y:e}=Cd();xt.aspect=window.innerWidth/window.innerHeight,xt.position.set(0,e,i),xt.lookAt(0,0,0),al(i)}Rd();function DI(){const e=new Float32Array(10500),t=new Float32Array(3500*3);for(let r=0;r<3500;r++){const a=Math.random()*Math.PI*2,s=Math.acos(2*Math.random()-1),o=28+Math.random()*32;e[r*3]=o*Math.sin(s)*Math.cos(a),e[r*3+1]=o*Math.sin(s)*Math.sin(a),e[r*3+2]=o*Math.cos(s),Math.random()<.65?(t[r*3]=.9+Math.random()*.1,t[r*3+1]=.9+Math.random()*.1,t[r*3+2]=1):(t[r*3]=.6+Math.random()*.4,t[r*3+1]=.3+Math.random()*.4,t[r*3+2]=1)}const n=new Kt;return n.setAttribute("position",new En(e,3)),n.setAttribute("color",new En(t,3)),new vf(n,new lu({size:.1,vertexColors:!0,transparent:!0,opacity:.9}))}const vd=DI();fs.add(vd);function bI(){const t=document.createElement("canvas");t.width=1024,t.height=512;const n=t.getContext("2d");n.fillStyle="#000000",n.fillRect(0,0,1024,512);const r=n.createRadialGradient(1024*.82,512*.55,0,1024*.82,512*.55,1024*.28);r.addColorStop(0,"rgba(16,12,22,0.3)"),r.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=r,n.fillRect(0,0,1024,512);const a=n.createRadialGradient(1024*.18,512*.55,0,1024*.18,512*.55,1024*.28);a.addColorStop(0,"rgba(23,14,36,0.3)"),a.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=a,n.fillRect(0,0,1024,512);for(let s=0;s<6;s++){const o=Math.random()*1024,l=Math.random()*512,c=30+Math.random()*90,u=n.createRadialGradient(o,l,0,o,l,c);u.addColorStop(0,`rgba(${60+Math.random()*60},${Math.random()*10},${130+Math.random()*80},0.18)`),u.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=u,n.fillRect(0,0,1024,512)}return new Vo(t)}const xd=new _n(new na(72,42),new Bo({map:bI(),transparent:!0,depthWrite:!1}));xd.position.z=-18;fs.add(xd);const an=new Pr;fs.add(an);const yd=new su(new Uint8Array([0,0,0,255]),1,1);yd.needsUpdate=!0;const gr=document.createElement("canvas");gr.width=2048;gr.height=1024;const vi=gr.getContext("2d"),Dd=new Vo(gr),bd=new In({vertexShader:vI,fragmentShader:xI,uniforms:{deepColor:{value:new Ge(1718896)},midColor:{value:new Ge(2644128)},edgeColor:{value:new Ge(2644128)},landColor:{value:new Ge(10972336)},landBright:{value:new Ge(14865656)},landDark:{value:new Ge(2629202)},landMask:{value:yd},highlightMask:{value:Dd}}}),wd=new _n(new as(Ir,64,64),bd);an.add(wd);an.add(new _n(new as(Ir+.1,64,64),new In({vertexShader:CI,fragmentShader:RI,uniforms:{glowColor:{value:new Ge(11150062)},glowPower:{value:1.5},opacity:{value:.22}},transparent:!0,blending:2,depthWrite:!1,side:0})));let no=null,jr=null;function Ld(){return no||(no=fetch("/data/countries-50m.json").then(i=>i.json()).then(i=>{const e=AI(i,i.objects.countries);return e.features.forEach(t=>{t.properties=t.properties||{},t.properties.ISO_A2=MI[parseInt(t.id,10)]||"-99"}),jr=e,e})),no}function Od(i,e,t){const n=(90-i)*(Math.PI/180),r=(e+180)*(Math.PI/180);return new G(-t*Math.sin(n)*Math.cos(r),t*Math.cos(n),t*Math.sin(n)*Math.sin(r))}async function wI(i,e,t){try{const n=await Ld(),r=e+.007,a=[];n.features.forEach(c=>{const u=c.geometry;if(!u)return;(u.type==="Polygon"?[u.coordinates]:u.type==="MultiPolygon"?u.coordinates:[]).forEach(d=>d.forEach(h=>{const E=h.map(([p])=>p);if(Math.max(...E)-Math.min(...E)>350)return;const A=h.map(([p,m])=>Od(m,p,r));for(let p=0;p<A.length-1;p++){const m=A[p],g=A[p+1],T=Math.max(1,Math.ceil(m.angleTo(g)/.04));for(let N=0;N<T;N++){const v=m.clone().lerp(g,N/T).normalize().multiplyScalar(r),C=m.clone().lerp(g,(N+1)/T).normalize().multiplyScalar(r);a.push(v.x,v.y,v.z,C.x,C.y,C.z)}}}))});const s=new Kt;s.setAttribute("position",new Vt(a,3));const o=new so({color:14721279,transparent:!0,opacity:0,blending:2,depthWrite:!1}),l=new so({color:16765183,transparent:!0,opacity:0,blending:2,depthWrite:!1});i.add(new Vl(s,o)),i.add(new Vl(s.clone(),l)),bt.to(o,{opacity:t*.5,duration:1.8,delay:.4}),bt.to(l,{opacity:t*.15,duration:1.8,delay:.6})}catch(n){console.warn("GeoJSON error",n)}}wI(an,Ir,1);async function LI(){const t=document.createElement("canvas");t.width=2048,t.height=1024;const n=t.getContext("2d");n.fillStyle="#000",n.fillRect(0,0,2048,1024),n.fillStyle="#fff",(await Ld()).features.forEach(s=>{const o=s.geometry;if(!o)return;(o.type==="Polygon"?[o.coordinates]:o.type==="MultiPolygon"?o.coordinates:[]).forEach(c=>{n.beginPath(),c.forEach(u=>{const f=u.map(([d])=>d);Math.max(...f)-Math.min(...f)>350||(u.forEach(([d,h],E)=>{const A=(d+180)/360*2048,p=(90-h)/180*1024;E===0?n.moveTo(A,p):n.lineTo(A,p)}),n.closePath())}),n.fill("evenodd")})});const a=new Vo(t);return a.anisotropy=Ii.capabilities.getMaxAnisotropy(),a}LI().then(i=>{bd.uniforms.landMask.value=i,i.needsUpdate=!0}).catch(i=>console.warn("Texture error",i));function OI(i){const e=i.clone().normalize(),t=Math.acos(Math.max(-1,Math.min(1,e.y)));let r=Math.atan2(e.z,-e.x)*(180/Math.PI)-180;return r<-180&&(r+=360),{lat:90-t*(180/Math.PI),lon:r}}function PI(i,e){return jr?jr.features.find(t=>t.geometry&&fI(t,[e,i]))??null:null}function Pd(i){return jr?jr.features.find(e=>e.properties?.ISO_A2===i)??null:null}function Gi(i){const e=gr.width,t=gr.height;if(vi.clearRect(0,0,e,t),i){const n=i.geometry,r=n.type==="Polygon"?[n.coordinates]:n.type==="MultiPolygon"?n.coordinates:[];vi.fillStyle="#fff",r.forEach(a=>{vi.beginPath(),a.forEach(s=>{s.forEach(([o,l],c)=>{const u=(o+180)/360*e,f=(90-l)/180*t;c===0?vi.moveTo(u,f):vi.lineTo(u,f)}),vi.closePath()}),vi.fill("evenodd")})}Dd.needsUpdate=!0}function UI(i,e){const t=i.clone();e.localToWorld(t);const n=xt.position.clone().normalize(),a=t.clone().normalize().dot(n),s=a>.05,o=t.clone().project(xt);return{x:(o.x*.5+.5)*window.innerWidth,y:(-o.y*.5+.5)*window.innerHeight,visible:s,dot:a}}const Ud=Object.values(_I.reduce((i,e)=>(i[e.flagCode]||(i[e.flagCode]={flagCode:e.flagCode,country:e.country,lat:0,lon:0,n:0,unis:[],delay:e.labelDelay}),i[e.flagCode].lat+=e.lat,i[e.flagCode].lon+=e.lon,i[e.flagCode].n++,i[e.flagCode].unis.push(e),e.labelDelay<i[e.flagCode].delay&&(i[e.flagCode].delay=e.labelDelay),i),{})).map(i=>({...i,lat:i.lat/i.n,lon:i.lon/i.n})),$c=document.getElementById("flag-nodes"),hs=document.getElementById("lines-svg");Ud.forEach(i=>{const e=document.createElement("div");e.className="flag-node",e.dataset.fc=i.flagCode;const t=document.createElement("img");t.src=`https://flagcdn.com/w80/${i.flagCode}.png`,t.alt=i.country,t.onerror=()=>{e.style.background="linear-gradient(135deg,#4a0095,#9930ee)",e.textContent=i.flagCode.toUpperCase(),e.style.fontSize="8px",e.style.fontWeight="700",e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="center"},e.appendChild(t),$c.appendChild(e),e.addEventListener("mouseenter",()=>{jc(i.flagCode,!0),gI()}),e.addEventListener("mouseleave",()=>jc(i.flagCode,!1)),e.addEventListener("click",()=>ns(i.flagCode));const n=document.createElement("div");n.className="flag-dot",n.dataset.fc=i.flagCode,$c.appendChild(n);const r=document.createElementNS("http://www.w3.org/2000/svg","line");r.setAttribute("data-fc",i.flagCode),r.setAttribute("class","flag-connector-line"),hs.appendChild(r)});function jc(i,e){const t=document.querySelector(`.flag-node[data-fc="${i}"]`);if(t&&(t.style.transform=e?"translate(-50%,-50%) scale(1.25)":"translate(-50%,-50%)"),e){const n=Gd[i];n&&(Pn=n,Gi(Pd(n)),Cn.classList.add("country-hover"))}else Gi(null),Cn.classList.remove("country-hover"),Pn=null}let Mn=-1,Ui=!0;const sl='<svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15"><rect x="5" y="3" width="5" height="18" rx="2"/><rect x="14" y="3" width="5" height="18" rx="2"/></svg>',Fd='<svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15"><polygon points="6,3 20,12 6,21"/></svg>',Oo={US:"us",MX:"mx",CO:"co",CL:"cl",CR:"cr",CA:"ca",ES:"es",DE:"de",BR:"br",AR:"ar",UY:"uy",ZA:"za",CN:"cn",GT:"gt",PY:"py",NI:"ni",PT:"pt",BE:"be",EC:"ec",IT:"it"},Gd=Object.fromEntries(Object.entries(Oo).map(([i,e])=>[e,i]));function ns(i){const e=II[i];e!==void 0&&(Mn=e,NI(),cl(e),document.getElementById("country-panel").classList.add("visible"),document.getElementById("country-panel").setAttribute("aria-hidden","false"),document.getElementById("panel-backdrop").classList.add("visible"),bt.to(Sr,{speed:0,duration:.5,ease:"power2.in"}),Ui=!1,zt.innerHTML=Fd,zt.classList.remove("is-playing"),zt.setAttribute("aria-label","Reanudar rotación"))}function ol(){document.getElementById("country-panel").classList.remove("visible"),document.getElementById("country-panel").setAttribute("aria-hidden","true"),document.getElementById("panel-backdrop").classList.remove("visible"),Mn=-1,Pn=null,Gi(null),Cn.classList.remove("country-hover"),Ui&&bt.to(Sr,{speed:.08,duration:1.8,ease:"power2.out"})}function Jc(){Ui||(Ui=!0,bt.to(Sr,{speed:.08,duration:1.8,ease:"power2.out"}),zt.innerHTML=sl,zt.classList.add("is-playing"),zt.setAttribute("aria-label","Pausar rotación"))}function ll(i){if(Mn===-1)return;Mn=(Mn+i+Kn.length)%Kn.length,cl(Mn);const e=Kn[Mn].flagCode,t=Gd[e];t&&(Pn=t,Gi(Pd(t)))}function FI(i){const e=document.getElementById("cp-accordion");e.innerHTML="",i.forEach(t=>{const n=t.modality.includes("Virtual")&&t.modality.includes("Presencial"),r=n?"mixta":t.modality.includes("Virtual")?"virtual":"presencial",a=n?"Presencial / Virtual":t.modality.includes("Virtual")?"Virtual":"Presencial",s=document.createElement("div");s.className="acc-item",s.innerHTML=`
    ...
    `,s.querySelector(".acc-header").addEventListener("click",()=>{const o=s.classList.contains("open");e.querySelectorAll(".acc-item.open").forEach(l=>l.classList.remove("open")),o||s.classList.add("open")}),e.appendChild(s)})}function cl(i){const e=Kn[i],t=document.querySelector(".cp-body");t&&(t.scrollTop=0),document.getElementById("cp-photo").src=e.photo,document.getElementById("cp-photo").alt=e.name,document.getElementById("cp-flag").src=`https://flagcdn.com/80x60/${e.flagCode}.png`,document.getElementById("cp-flag").alt=e.name,document.getElementById("cp-country-name").textContent=e.name,FI(e.universities),document.getElementById("cp-pager-count").textContent=`${i+1} / ${Kn.length}`;const n=document.getElementById("cp-dots");n.innerHTML="",Kn.forEach((r,a)=>{const s=document.createElement("div");s.className="cp-dot"+(a===i?" active":""),s.addEventListener("click",()=>{Mn=a,cl(a)}),n.appendChild(s)})}document.getElementById("cp-close").addEventListener("click",ol);document.getElementById("cp-prev").addEventListener("click",()=>ll(-1));document.getElementById("cp-next").addEventListener("click",()=>ll(1));document.getElementById("panel-backdrop").addEventListener("click",ol);function Bd(i){Mn===-1?ns(Kn[i<0?Kn.length-1:0].flagCode):ll(i)}document.getElementById("fn-prev").addEventListener("click",()=>Bd(-1));document.getElementById("fn-next").addEventListener("click",()=>Bd(1));const zt=document.getElementById("globe-toggle");zt.innerHTML=sl;zt.addEventListener("click",()=>{Ui=!Ui,Ui?(Mn===-1&&bt.to(Sr,{speed:.08,duration:1.2,ease:"power2.out"}),zt.innerHTML=sl,zt.classList.add("is-playing"),zt.setAttribute("aria-label","Pausar rotación")):(bt.to(Sr,{speed:0,duration:.5,ease:"power2.in"}),zt.innerHTML=Fd,zt.classList.remove("is-playing"),zt.setAttribute("aria-label","Reanudar rotación"))});let Po=0,Uo=0,Wn={xMin:0,xMax:9999,yMin:0,yMax:9999};function ul(){const i=window.innerWidth,e=window.innerHeight,t=16,n=document.getElementById("left-hero"),r=document.getElementById("hint-panel"),a=document.getElementById("inscripciones-card"),s=n?n.getBoundingClientRect().right+t:t,o=r&&r.offsetParent?r.getBoundingClientRect().left-t:i,l=a&&a.offsetParent?a.getBoundingClientRect().left-t:i;Wn={xMin:s,xMax:Math.min(o,l),yMin:t,yMax:e-t}}function GI(){const i=window.innerWidth;return i<480?38:i<768?44:40}function Vd(i){const e=i.x-Po,t=i.y-Uo,n=Math.sqrt(e*e+t*t)||1;return{nx:e/n,ny:t/n}}function BI(i){const{nx:e,ny:t}=Vd(i),n=GI(),r=i.dot??1,a=Math.max(0,Math.min(1,(r-.05)/.5)),s=a*a*(3-2*a),o=18+(n-18)*s,l=-t,c=e,u=(1-s)*.98,f=e*(1-u)+l*u,d=t*(1-u)+c*u,h=Math.sqrt(f*f+d*d)||1;return{x:i.x+f/h*o,y:i.y+d/h*o}}function VI(){const i=new G(0,0,0).project(xt);if(Po=(i.x*.5+.5)*window.innerWidth,Uo=(-i.y*.5+.5)*window.innerHeight,zd)if(window.innerWidth>900){const l=xt.position.length(),c=Math.asin(Math.min(.999,Ir/l)),u=Math.tan(c)/Math.tan(xt.fov*Math.PI/360)*(window.innerHeight/2);oi.style.left=Po+"px",oi.style.top=Uo+u+16+"px",oi.style.bottom="auto",oi.style.transform="translateX(-50%)"}else oi.style.left="",oi.style.top="",oi.style.bottom="",oi.style.transform="";const e=110,t=26,n=5,r=46,a=e+n,s=Ud.map(l=>{const c=UI(Od(l.lat,l.lon,Ir+.05),an),u=c.visible,f=BI(c),d=Math.max(Wn.xMin+e,Math.min(Wn.xMax-e,f.x)),h=Math.max(Wn.yMin+t,Math.min(Wn.yMax-t,f.y));return{group:l,flagPos:c,show:u,ax:d,ay:h}}),o=s.filter(l=>l.show);for(let l=0;l<12;l++){let c=!1;for(let u=0;u<o.length;u++)for(let f=u+1;f<o.length;f++){const d=o[u],h=o[f],E=(d.group.n-1)*r/2+t,A=(h.group.n-1)*r/2+t,p=E+A+n,m=Math.abs(d.ax-h.ax),g=Math.abs(d.ay-h.ay);if(m>=a*2||g>=p*2)continue;const T=(d.ay+h.ay)/2;d.ay<=h.ay?(d.ay=T-p,h.ay=T+p):(d.ay=T+p,h.ay=T-p),d.ay=Math.max(Wn.yMin+E,Math.min(Wn.yMax-E,d.ay)),h.ay=Math.max(Wn.yMin+A,Math.min(Wn.yMax-A,h.ay)),c=!0}if(!c)break}s.forEach(({group:l,flagPos:c,show:u})=>{const d=window.innerWidth>900?52:8,{nx:h,ny:E}=Vd(c),A=c.x+h*d,p=c.y+E*d,m=document.querySelector(`.flag-node[data-fc="${l.flagCode}"]`);m&&(m.style.left=A+"px",m.style.top=p+"px",m.style.opacity=u?"1":"0",m.style.visibility=u?"visible":"hidden",m.style.pointerEvents=u?"auto":"none");const g=document.querySelector(`.flag-dot[data-fc="${l.flagCode}"]`);g&&(g.style.left=c.x+"px",g.style.top=c.y+"px",g.style.opacity=u?"1":"0",g.style.visibility=u?"visible":"hidden");const T=hs.querySelector(`line[data-fc="${l.flagCode}"]`);T&&(T.setAttribute("x1",c.x),T.setAttribute("y1",c.y),T.setAttribute("x2",A-h*30),T.setAttribute("y2",p-E*30),T.style.opacity=u?"1":"0",T.style.visibility=u?"visible":"hidden")})}const{z:is}=Cd();an.scale.set(.001,.001,.001);bt.set(["#left-hero","#hint-panel"],{y:-16});bt.set(["#inscripciones-card","#footer-nav"],{y:16});bt.to("#globe-canvas",{opacity:1,duration:1.8,ease:"power2.inOut",delay:.1});bt.to(an.scale,{x:1,y:1,z:1,duration:2.2,ease:"expo.out",delay:.25});xt.position.z=is+5;requestAnimationFrame(()=>{al(is),ul(),bt.to(xt.position,{z:is,duration:3.2,ease:"power2.inOut",delay:.1})});document.fonts?.ready&&document.fonts.ready.then(()=>{al(is),ul()});bt.to("#left-hero",{opacity:1,y:0,duration:.9,ease:"power2.out",delay:1.6});bt.to("#hint-panel",{opacity:1,y:0,duration:.8,ease:"power2.out",delay:1.9});bt.to("#footer-nav",{opacity:1,y:0,duration:.7,ease:"power2.out",delay:2.1});bt.to("#inscripciones-card",{opacity:1,y:0,duration:.7,ease:"power2.out",delay:2.2});const Qc=new Gf,io=new Ke;let Pn=null;function HI(i,e){io.x=i/window.innerWidth*2-1,io.y=e/window.innerHeight*-2+1,Qc.setFromCamera(io,xt);const t=Qc.intersectObject(wd);return t.length>0?t[0]:null}function Hd(i,e){const t=HI(i,e);if(!t)return null;const n=an.worldToLocal(t.point.clone()),{lat:r,lon:a}=OI(n);return PI(r,a)}let ra=!1,Va={x:0,y:0},Br=null;Cn.addEventListener("pointerdown",i=>{i.isPrimary&&(ra=!0,Va={x:i.clientX,y:i.clientY},Br={x:i.clientX,y:i.clientY},Cn.setPointerCapture(i.pointerId))});window.addEventListener("pointerup",i=>{i.isPrimary&&(ra=!1,TI())});window.addEventListener("pointermove",i=>{if(!i.isPrimary||!ra)return;const e=i.clientX-Va.x,t=i.clientY-Va.y;an.rotation.y+=e*.005,an.rotation.x+=t*.005,an.rotation.x=Math.max(-.6,Math.min(.6,an.rotation.x)),Va={x:i.clientX,y:i.clientY},SI()});Cn.addEventListener("pointermove",i=>{if(!i.isPrimary||ra)return;const e=Hd(i.clientX,i.clientY),t=e?.properties?.ISO_A2??null;t!==Pn&&(Pn=t,t&&wo.has(t)?(Gi(e),Cn.classList.add("country-hover")):(Gi(null),Cn.classList.remove("country-hover")))});Cn.addEventListener("pointerup",i=>{if(!i.isPrimary||!Br)return;const e=i.clientX-Br.x,t=i.clientY-Br.y;if(Br=null,Math.sqrt(e*e+t*t)>8)return;if(Mn!==-1){ol(),Jc();return}if(Pn&&wo.has(Pn)){const a=Oo[Pn];if(a){ns(a);return}}const n=Hd(i.clientX,i.clientY),r=n?.properties?.ISO_A2??null;if(r&&wo.has(r)){Pn=r,Gi(n),Cn.classList.add("country-hover");const a=Oo[r];if(a){ns(a);return}}Jc()});const oi=document.getElementById("footer-nav");let zd=!1;setTimeout(()=>{zd=!0},3200);const eu=new Bf,Sr={speed:.08};function kd(){requestAnimationFrame(kd);const i=eu.getDelta();eu.elapsedTime,ra||(an.rotation.y-=i*Sr.speed),vd.rotation.y+=i*.004,VI(),Ii.render(fs,xt)}kd();window.addEventListener("resize",()=>{xt.aspect=window.innerWidth/window.innerHeight,xt.updateProjectionMatrix(),Ii.setSize(window.innerWidth,window.innerHeight),hs.setAttribute("viewBox",`0 0 ${window.innerWidth} ${window.innerHeight}`),requestAnimationFrame(()=>{Rd(),ul()})});hs.setAttribute("viewBox",`0 0 ${window.innerWidth} ${window.innerHeight}`);
